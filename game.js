function play(){
    ...
    if(type==1) {
        ...
        $.ajax({
            method: "get",
            url: "https://3a60cb8f.r8.cpolar.top/getScoreByName/"+name,
        ...
        if(id==1||id==2||id==3){
            $.ajax({
                method: "get",
                url: "https://3a60cb8f.r8.cpolar.top/getMemberScoreById/"+id,
                success:function(res){
                    var memberScore = res;
            ...
            $.ajax({
                method: "get",
                url: "https://3a60cb8f.r8.cpolar.top/userPlay/"+name+"/"+id+"/"+number,
                success:function(res){
                    console.log(res);
                    alert(res);
                }
